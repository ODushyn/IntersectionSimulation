...
public class FuzzyDecisionMaker {
     ...
     */
    public long getTimeDelay(double waitingVehiclesOfNextGreenPhase, double waitingVehiclesOfCurrentGreenPhase){
        ...
        /*System.out.println("Vehicles of current green phase: " + waitingVehiclesOfCurrentGreenPhase);
